...
real <- "EXP1_Ab_Titration_Instructions.xlsx"
for (f in c(real,
            ...
            "EXP1_Ab_Titration_Instructions.xlsx.bak",
            "EXP1_Ab_Titration_Instructions.xls",
...
invisible(file.create(file.path(fd, "EXP2_Ab_Titration_Instructions.xlsx")))
