...
real <- "EXP1_Ab_Titration_Instructions_3_1.xlsx"
for (f in c(real,
            ...
            "EXP1_Ab_Titration_Instructions_3_1.xlsx.bak",
            "EXP1_Ab_Titration_Instructions_3_1.xls",
...
invisible(file.create(file.path(fd, "EXP2_Ab_Titration_Instructions_3_1.xlsx")))
